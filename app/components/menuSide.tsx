export default function MenuSide(props) {
    return (
        <div className="sideMenu">
            ...
            <img src="https://media.istockphoto.com/id/1316810209/fr/vectoriel/carte-de-ville-monochrome-de-paris-france-plan-des-rues-fond-urbain-sch%C3%A9ma-vectoriel-avec.jpg?s=1024x1024&w=is&k=20&c=Gkc676tqcsBmegsspNGn_hg3xpzge4iNFYznHxGfRcE=" className="imageMenu" alt="" />
        </div>
    )
}