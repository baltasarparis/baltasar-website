        ...
        <div id="approche" ref={ref} className="py-12">
            <div className="w-screen mb-6">
                <div className="rounded-xl bg-white w-[100%] mx-auto py-12">
                    <div
                        className="w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6"
                        ref={elementRef}
                    >
                        <div
                            className={`mb-6 md:mb-0 rounded-xl bg-cover bg-center transition-transform duration-1000 ease-out ${
                                isVisible
                        ...
                        <div
                            className={`w-full rounded-md bg-gray-100 flex flex-col p-6 md:p-12 relative transition-transform duration-1000 ease-out ${
                                isVisible
                                    ? 'translate-y-0 opacity-100'
                                    : 'translate-y-20 opacity-0'
                            }`}
